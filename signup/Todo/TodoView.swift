...
struct TodoView: View {
    ...
    var body: some View {
        ...
        Button(action: {
            ...
            Image(systemName: self.remove ? "xmark.circle" : "trash").resizable().frame(width: 25, height: 25).foregroundColor(.black).offset( y: 30)
        }
        ...
        ZStack(alignment: .bottomTrailing) {
            ...
            VStack(spacing: 10){
                ...
                HStack{
                    ...
                    Text("Today's Medication").font(.title).foregroundColor(.white)
    ...
    var body : some View{
        ...
        ZStack(alignment: .bottomTrailing) {
            ...
            Button(action: {
                ...
                content.title = "Medipack"
                content.body = "Did you take your medication today?"
                ...
                let reminder = UNNotificationAction(identifier: NotificationAction.reminder.rawValue, title: "Dismiss", options: [])
                ...
                // add request to the notification centre
